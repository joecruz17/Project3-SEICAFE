...
(async function() {
  ...
  const items = await Item.create([
    ...
    {name: 'Yosemite', emoji: '🍕', category: categories[3], price: 223.95, imageUrl: 'https://i.imgur.com/sTiZeyC.jpg'},
    {name: 'Autumn Willow', emoji: '🍝', category: categories[3], price: 711.95, imageUrl: 'https://i.imgur.com/DnKTBCR.jpg'},
    {name: 'Nature Falls', emoji: '🍞', category: categories[3], price: 100.95, imageUrl: 'https://i.imgur.com/qBGPVQJ.jpg'},
    ...
    {name: 'Jesus', emoji: '🍨', category: categories[5], price: 112.95, imageUrl: 'https://i.imgur.com/itmc5Gy.jpg'},
    {name: 'Goat', emoji: '🧁', category: categories[5], price: 110.95, imageUrl: 'https://i.imgur.com/yNQ8hmN.jpg'},
    {name: 'The Maidens Dress', emoji: '🍮', category: categories[5], price: 232.95, imageUrl: 'https://i.imgur.com/FThG1Gz.jpg'},
    {name: 'Yellow Umbrella', emoji: '🍰', category: categories[5], price: 344.95, imageUrl: 'https://i.imgur.com/sDLrdKY.jpg'},
